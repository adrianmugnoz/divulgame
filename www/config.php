...
//$globals['url_shortener'] = 'a.divulgame.net';
//$globals['url_shortener_to'] = 'a.divulgame.net';
...
$globals['karma_clicks_bonus'] = 0.3; // Bonus to give due to clicks, it reaches this value when clicks/votes = 10;
...
$globals['twitter_consumer_key'] = '';
$globals['twitter_consumer_secret'] = '';
$globals['twitter_token'] = '';
$globals['twitter_token_secret'] = '';
...
$globals['google_maps_in_links'] = true; // true si quieres habilitarlo para noticias


//Google Plus authentificate
$globals['oauth']['gplus']['consumer_key'] = '';
$globals['oauth']['gplus']['consumer_secret'] = '';
