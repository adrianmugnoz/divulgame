...
echo ".count {\n"; 
echo "background: url(http://www.divulgame.net/img/mnm/api/counter.png) no-repeat;\n";   
...
if ($res) {
	echo '<a href="/story.php?id='.$res->link_id.'" target="_parent" onmouseover="changebutton(\'mnm_vote\',\'mnm_yesover\')" onmouseout="changebutton(\'mnm_vote\',\'mnm_vote_notover\')"><img style="border: 0" src="'.$mnm_vote.'" target="_parent" name="mnm_vote"/></a> <div class="count">'.($res->link_votes+$res->link_anonymous).'</div>';
} else {
